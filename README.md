...
<a href='https://www.linkedin.com/in/rodrigoazlima/' target="_blank"><img align="left" alt="linkedin" src="https://img.shields.io/badge/-LinkedIn-0077B5?style=flat&logo=Linkedin&logoColor=white" height="28px"/></a>

<br/><br/>

Full-stack dev with a Java/JS background, now deep in local-first AI tooling — LLM routers, agentic coding loops, on-device inference. I like taking a stack apart until it runs on my own hardware instead of someone else's API bill.

### 🧐 More About Me

- 🔭 &nbsp; Currently building **[LocalRouter](https://github.com/rodrigoazlima/LocalRouter)** — a local-first LLM router with intelligent failover and error-aware provider blocking
- 🤖 &nbsp; Deep in agentic coding: Claude Code, Ralph-style autonomous loops, Obsidian vaults driven by AI agents
- 🎲 &nbsp; Side quest: AI-assisted tabletop RPG tooling — **[NexusCampaigns](https://github.com/rodrigoazlima/NexusCampaigns)**, **[pathway2e](https://github.com/rodrigoazlima/pathway2e)**
- 🌱 &nbsp; Learning ROCm/HIP for AMD GPU inference — see **[llama.cpp-moe-amd-lowvram](https://github.com/rodrigoazlima/llama.cpp-moe-amd-lowvram)**
- 👨🏻‍💻 &nbsp; Most of my projects are on [GitHub](https://github.com/rodrigoazlima?tab=repositories)
- 📫 &nbsp; Reach me on [LinkedIn](https://www.linkedin.com/in/rodrigoazlima/)
